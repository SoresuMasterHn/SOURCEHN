...
p9o.uu rfn l      *********** Compilation Directives ***************************************
       ctl-opt option(*nodebugio:*srcstmt) dftactgrp(*no) ;
       ctl-opt main(Pr_Main) ;
       ctl-opt copyright('Testing SQL Example - Mario Salgado 2022');
      ...
      *********** Variables and data structures ********************************
       ...
       dcl-s Ini01      zoned(10:0) inz(0) ;
       dcl-s Fin01    zoned(10:0) inz(10);
      ...
      ***************** Begin Screen procedures ********************************
       ...
       dcl-proc Pr_WriteScreen ;
         ...
         // Secondary titles
         TITLE2 = Pr_Center('Created by Mario Salgado':%len(TITLE2)) ;
         TITLE3 = Pr_Center('SQL Labs-Honduras 2022':%len(TITLE3)) ;
               ...
               if Pr_ScreenValidation(Par_Choice) = *Off ;
                ...
                if WDWCHOICE = 'Y' ;
                  ...
                  exec sql
                    ...
                    STATE =:STATETASK ,
                    OWNER =:CurrentUser
                    WHERE TASK_ID=: CRUDTASKID with nc;
